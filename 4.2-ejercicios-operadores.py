...
def mayor_edad(edad):
    # Retorna si es mayor de edad (18+)
    return edad >= 18


def edad_18_45(edad):
    # Retorna si la edad es mayor de 18 y menor de 45
    return 18 < edad < 45


def edad_45_60(edad):
    # Retorna si la edad es mayor de 45 y menor de 60
    return 45 < edad < 60


def edad_mayor_60(edad):
    # Retorna si la edad es mayor de 60
    return edad > 60
